...
export default function confidentalite() {


    return (
        <div className="px-24" >
            <h1 className="text-center text-5xl font-bold pt-40 mb-12">Politique de confidentialité
            </h1>

            <p>Le site web christine-madec-psychologue.fr est détenu par Christine Madec, qui est un contrôleur de données de vos données  <br/><br/>
                Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par christine-madec-psychologue.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d&apos;utiliser le site web de christine-madec-psychologue.fr <br/> <br/>
                Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.
            </p> <br/>

            <h2 className='font-bold text-2xl'>Les informations personnelles que nous collectons :</h2><br/>

            <p>Lorsque vous visitez le christine-madec-psychologue.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme &quot;informations sur les appareils&quot;.<br/><br/>
                Dans le cas de l’utilisation du formulaire de contact nous prenons les informations suivantes : Nom ; Prénom ; adresse email et numéro de téléphone dans les cas de confirmation de rdv ou de réponse à l’un des vos questionnements. Vos informations ne seront en aucun cas utilisées pour à d’autres fin commerciales.
                ,</p><br/>


            <h2 className='font-bold text-2xl'>Pourquoi traitons-nous vos données ?
            </h2><br/>

            <p>Notre priorité absolue est la sécurité des données et, à ce titre, nous ne pouvons traiter que des données minimales sur les utilisateurs, uniquement dans la mesure où cela est absolument nécessaire pour maintenir le site web. Les informations collectées automatiquement sont utilisées uniquement pour identifier les cas potentiels d&apos;abus et établir des informations statistiques concernant l&apos;utilisation du site web. Ces informations statistiques ne sont pas autrement agrégées de manière à identifier un utilisateur particulier du système.
                Vous pouvez visiter le site web sans nous dire qui vous êtes ni révéler d&apos;informations, par lesquelles quelqu&apos;un pourrait vous identifier comme un individu spécifique et identifiable. Toutefois, si vous souhaitez utiliser certaines fonctionnalités du site web, ou si vous souhaitez recevoir notre lettre d&apos;information ou fournir d&apos;autres détails en remplissant un formulaire, vous pouvez nous fournir des données personnelles, telles que votre e-mail, votre prénom, votre nom, votre ville de résidence, votre organisation, votre numéro de téléphone. Vous pouvez choisir de ne pas nous fournir vos données personnelles, mais il se peut alors que vous ne puissiez pas profiter de certaines fonctionnalités du site web. Par exemple, vous ne pourrez pas recevoir notre bulletin d&apos;information ou nous contacter directement à partir du site web. Les utilisateurs qui ne savent pas quelles informations sont obligatoires sont invités à nous contacter via chrismade@orange.fr.
            </p><br/>

            <h2 className='font-bold text-2xl'>Directeur de publication</h2><br/>

            <p>Le Directeur de la publication du Site est Christine Madec.</p><br/>

            <h2 className='font-bold text-2xl'>Nous contacter</h2><br/>

            <p>Par téléphone : +33614632369<br/>
                Par email : chrismade@orange.fr<br/>
                Par courrier : Chemin départemental 46</p><br/>

            <h2 className='font-bold text-2xl'>Données personnelles</h2><br/>

            <p>Notre priorité absolue est la sécurité des données et, à ce titre, nous ne pouvons traiter que des données minimales sur les utilisateurs, uniquement dans la mesure où cela est absolument nécessaire pour maintenir le site web. Les informations collectées automatiquement sont utilisées uniquement pour identifier les cas potentiels d&apos;abus et établir des informations statistiques concernant l&apos;utilisation du site web. Ces informations statistiques ne sont pas autrement agrégées de manière à identifier un utilisateur particulier du système.<br/><br/>
                Vous pouvez visiter le site web sans nous dire qui vous êtes ni révéler d&apos;informations, par lesquelles quelqu&apos;un pourrait vous identifier comme un individu spécifique et identifiable. Toutefois, si vous souhaitez utiliser certaines fonctionnalités du site web, ou si vous souhaitez recevoir notre lettre d&apos;information ou fournir d&apos;autres détails en remplissant un formulaire, vous pouvez nous fournir des données personnelles, telles que votre e-mail, votre prénom, votre nom, votre ville de résidence, votre organisation, votre numéro de téléphone. Vous pouvez choisir de ne pas nous fournir vos données personnelles, mais il se peut alors que vous ne puissiez pas profiter de certaines fonctionnalités du site web. Par exemple, vous ne pourrez pas recevoir notre bulletin d&apos;information ou nous contacter directement à partir du site web. Les utilisateurs qui ne savent pas quelles informations sont obligatoires sont invités à nous contacter via chrismade@orange.fr.
            </p><br/>

            <h2 className='font-bold text-2xl'>Vos droits :</h2><br/>
            ...
            <h2 className='font-bold text-2xl'>Sécurité de l&apos;information :
            </h2><br/>
            ...
            <h2 className='font-bold text-2xl'>Divulgation légale :
            ...
            <h2 className='font-bold text-2xl'>Informations de contact :

            </h2><br/>

            <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à chrismade@orange.fr.
            </p><br/>
